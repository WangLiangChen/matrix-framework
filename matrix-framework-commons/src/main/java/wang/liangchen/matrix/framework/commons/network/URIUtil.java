...
public enum URIUtil {
    ...
    public URI toURI(String uriString, String... more) {
        ValidationUtil.INSTANCE.notNullAndBlank(uriString, "uriString must not be blank");
        try {
    ...
    public URL toURL(String urlString, String... more) {
        ValidationUtil.INSTANCE.notNullAndBlank(urlString, "urlString must not be blank");
        try {
    ...
    public URI expandURI(URI uri, String... more) {
        ValidationUtil.INSTANCE.notNull(uri, "uri must not be null");
        return URI.create(resolveURIString(uri.toString(), more));
    }

    public URL expendURL(URL url, String... more) {
        ValidationUtil.INSTANCE.notNull(url, "url must not be null");
        try {

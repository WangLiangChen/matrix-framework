...
public final class ProductFactory extends AbstractDomainFactory {

    /**
     * 创建全新的商品聚合。
     */
    public Product create(String name, String subtitle, CategoryId categoryId, BrandId brandId,
                          List<AttributeValue> attributeValues, List<SkuTemplate> skuTemplates) {
    ...
    public Product reconstitute(ProductId id, String name, String subtitle, CategoryId categoryId, BrandId brandId,
                                List<AttributeValue> attributeValues, List<SkuSummary> skuSummaries, boolean listed) {

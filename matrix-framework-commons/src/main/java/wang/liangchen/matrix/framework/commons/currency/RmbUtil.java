...
public enum RmbUtil {
    ...
    public String fen2Yuan(Long fen) {
        ValidationUtil.INSTANCE.notNull(MatrixExceptionLevel.WARN, fen, "fen can not by null");
        if (0 == fen) {
            return "0";
        }
    ...
    public Long yuan2Fen(String yuan) {
        ValidationUtil.INSTANCE.notBlank(MatrixExceptionLevel.WARN, yuan, "{ParameterNotBlank}");

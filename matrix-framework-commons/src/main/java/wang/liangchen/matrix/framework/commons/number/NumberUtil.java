...
public enum NumberUtil {
    ...
    public BigDecimal add(String v1, String v2, int scale) {
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN, v1, "v1 must not be blank");
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN, v2, "v1 must not be blank");
        ValidationUtil.INSTANCE.isTrue(MessageLevel.WARN, scale > -1, "scale must greater than -1");
    ...
    public BigDecimal add(BigDecimal v1, BigDecimal v2, int scale) {
        ValidationUtil.INSTANCE.notNull(MessageLevel.WARN, v1, "v1 must not be null");
        ValidationUtil.INSTANCE.notNull(MessageLevel.WARN, v2, "v1 must not be null");
        ValidationUtil.INSTANCE.isTrue(MessageLevel.WARN, scale > -1, "scale must greater than -1");

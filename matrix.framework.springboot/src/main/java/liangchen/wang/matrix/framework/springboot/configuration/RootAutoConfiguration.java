package liangchen.wang.matrix.framework.springboot.configuration;
...
/**
 * @Configuration 中所有带 @Bean 注解的方法都会被动态代理，因此调用该方法返回的都是同一个实例。ConfigurationClassPostProcessor

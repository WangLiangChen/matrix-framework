...
public enum BytesUtil {
    ...
    public byte[] toBytes(String data, Charset charset) {
        ...
        ValidationUtil.INSTANCE.notNull(MessageLevel.WARN, charset, "charset must not be null");
        return data.getBytes(charset);
    }

    public short toShort(byte[] bytes) {
        ValidationUtil.INSTANCE.notEmpty(MessageLevel.WARN, bytes, "bytes must not be null or empty");

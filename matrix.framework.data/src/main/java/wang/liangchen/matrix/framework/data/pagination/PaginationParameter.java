...
public class PaginationParameter extends EnhancedObject {
    ...
    public void setOrderBy(List<OrderBy> orderBy) {
        AssertUtil.INSTANCE.notEmpty(orderBy, "参数orderBy不能为空");
    ...
    public void addOrderBy(String orderby, OrderByDirection direction, Integer index) {
        AssertUtil.INSTANCE.notBlank(orderby, "参数orderby不能为空");
        AssertUtil.INSTANCE.notNull(direction, "参数direction不能为空");

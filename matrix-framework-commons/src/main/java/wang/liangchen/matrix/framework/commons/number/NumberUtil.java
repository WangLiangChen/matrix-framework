...
public enum NumberUtil {
    ...
    public BigDecimal add(String v1, String v2, int scale) {
        ValidationUtil.INSTANCE.notNullAndBlank(v1, "v1 must not be blank");
        ValidationUtil.INSTANCE.notNullAndBlank(v2, "v1 must not be blank");
        ValidationUtil.INSTANCE.isTrue(scale > -1, "scale must greater than -1");
    ...
    public BigDecimal add(BigDecimal v1, BigDecimal v2, int scale) {
        ValidationUtil.INSTANCE.notNull(v1, "v1 must not be null");
        ValidationUtil.INSTANCE.notNull(v2, "v1 must not be null");
        ValidationUtil.INSTANCE.isTrue(scale > -1, "scale must greater than -1");

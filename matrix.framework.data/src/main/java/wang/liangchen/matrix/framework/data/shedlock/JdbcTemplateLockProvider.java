...
public class JdbcTemplateLockProvider extends StorageBasedLockProvider {
    ...
    private static final String DEFAULT_TABLE_NAME = IDBLock.TABLE_NAME;
    ...
    public static final class Configuration {
        ...
        public static final class Builder {
            ...
            private ColumnNames columnNames = new ColumnNames("lock_key", "lock_until", "lock_datetime", "lock_owner");
            ...
            public Configuration build() {
                return new Configuration(jdbcTemplate, transactionManager, tableName, timeZone, columnNames, lockedByValue, useDbTime);
            }
        }

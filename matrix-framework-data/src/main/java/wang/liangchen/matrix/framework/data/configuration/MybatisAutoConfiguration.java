...
public class MybatisAutoConfiguration implements InitializingBean {
    ...
    private void applyConfiguration(SqlSessionFactoryBean factory) {
        ...
        if (configuration != null && coreConfiguration != null) {
            ...
            mapper.from(coreConfiguration::getArgNameBasedConstructorAutoMapping).to(configuration::setArgNameBasedConstructorAutoMapping);
            ...
            mapper.from(coreConfiguration::getAutoMappingUnknownColumnBehavior).to(configuration::setAutoMappingUnknownColumnBehavior);

...
import liangchen.wang.matrix.framework.data.mybatis.interceptor.PaginationInterceptor;
...
public class MybatisAutoConfiguration {
    ...
    private final static String DEFAULT_SCAN_PACKAGE = "liangchen.wang.matrix";

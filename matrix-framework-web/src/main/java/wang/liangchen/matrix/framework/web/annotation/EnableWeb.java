...
import wang.liangchen.matrix.framework.web.configuration.WebConfiguration;
...
public @interface EnableWeb {
    ...
    class WebImportSelector implements ImportSelector {
        ...
        public synchronized String[] selectImports(AnnotationMetadata annotationMetadata) {
            ...
            switch (webType) {
                case WEBMVC:
                    imports = new String[]{WebConfiguration.class.getName(), WebMvcAutoConfiguration.class.getName(), RequestResponseBodyMethodProcessorConfiguration.class.getName(), org.springframework.boot.autoconfigure.web.servlet.WebMvcAutoConfiguration.class.getName(), DelegatingWebMvcConfiguration.class.getName()};
                    break;
                case WEBFLUX:
                    imports = new String[]{WebConfiguration.class.getName(), WebFluxAutoConfiguration.class.getName(), org.springframework.boot.autoconfigure.web.reactive.WebFluxAutoConfiguration.class.getName(), DelegatingWebFluxConfiguration.class.getName()};
                    break;
                default:

...
public class SignatureClaim implements Serializable {
    ...
    public static SignatureClaim instance4Sign(String uri, String body) {
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN,uri, "uri must not be blank");
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN,body, "body must not be blank");
    ...
    public static SignatureClaim instance4Verify(String uri, String body, String signMessage) {
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN,uri, "uri must not be blank");
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN,body, "body must not be blank");
        ValidationUtil.INSTANCE.notBlank(MessageLevel.WARN,signMessage, "signMessage must not be blank");

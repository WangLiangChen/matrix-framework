package wang.liangchen.matrix.framework.spring.data.mybatis.handler;
...
import wang.liangchen.matrix.framework.spring.data.entity.ExtendedColumnValueDetail;

...
public final class AttributeCreatedEvent extends AbstractDomainEvent {

    private final AttributeId attributeId;
    private final String attributeName;
    private final AttributeType attributeType;

    public AttributeCreatedEvent(AttributeId attributeId, String attributeName, AttributeType attributeType) {
        super();
